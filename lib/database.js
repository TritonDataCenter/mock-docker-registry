...
Database.prototype._readFile = function _readFile(p, opts, cb) {
    fs.readFile(p, opts, function (readErr, content) {
        if (readErr) {
 ...
 */
Database.prototype.v2GetManifest = function (opts, cb) {
    ...
    var p = path.resolve(this.dataDir, 'v2', 'repos', opts.rar.remoteName,
 ...
 */
Database.prototype.v2CreateBlobReadStream = function (opts, cb) {
    assert.object(opts.rar, 'opts.rar');
